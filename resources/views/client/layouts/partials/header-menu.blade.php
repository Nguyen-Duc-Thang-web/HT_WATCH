<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="{{ route('trangchu') }}">HT WATCH</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    ...
                    {{ asset('cuahang') }}">Sản Phẩm</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link me-2" href="{{ asset('lienhe') }}">Liên Hệ</a>
                </li>
                <li class="nav-item">
            ...
            <form class="d-flex" role="search">
                <a href="{{ asset('giohang') }}" class="m-2 mr-4 ">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item dropdown mt-2">
                            <a class="hoa" id="navbarDropdown" class="nav-link dropdown-toggle" href="#"
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                @endif
                                <a class="nav-link" href="{{ route('hoso') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" class="mr-2"
