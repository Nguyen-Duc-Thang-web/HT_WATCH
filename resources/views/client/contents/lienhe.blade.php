...
@section('noidung')
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 mb-3 text-black">Liên lạc với chúng tôi</h2>
                </div>
                <div class="col-md-7">
                ...
                <div class="col-md-5 ml-auto">
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">TP.HÀ NỘI</span>
                        <p class="mb-0">ABC,BHUAI,JSAHJHISOFH,HN</p>
                    </div>
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">TP.HỒ CHÍ MINH</span>
                        <p class="mb-0">ABC,BHUAI,JSAHJHISOFH,HN</p>
                    </div>
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">TP.ĐÀ NẴNG</span>
                        <p class="mb-0">ABC,BHUAI,JSAHJHISOFH,HN</p>
                    </div>
